package com.github.starnowski.posmulten.demos.posmultenhibernate6springbootthymeleaf.utils;
...
import static com.github.starnowski.posmulten.demos.posmultenhibernate6springbootthymeleaf.configurations.PrimaryDataSourceConfiguration.SET_CURRENT_TENANT_FUNCTION_NAME;

public class TestUtils {

    public static final String CLEAR_DATABASE_SCRIPT_PATH = "/com/github/starnowski/posmulten/demos/posmultenhibernate6springbootthymeleaf/clean-database.sql";
    public static final String MULTI_TENANT_CONTEXT_AWARE_CONTROLLER_TEST_SCRIPT_PATH = "/com/github/starnowski/posmulten/demos/posmultenhibernate6springbootthymeleaf/controllers/MultiTenantContextAwareControllerTest-script.sql";
