...
INSERT INTO user_role (id, role, user_id, tenant_id) VALUES (nextval( 'user_role_SEQ' ), 'ADMIN', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'xds'); -- starnowski as ADMIN
INSERT INTO user_role (id, role, user_id, tenant_id) VALUES (nextval( 'user_role_SEQ' ), 'ADMIN', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'xds'); -- dude as ADMIN

INSERT INTO posts (id, userId, text) VALUES (nextval( 'posts_SEQ' ), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'This is a text content');
INSERT INTO posts (id, userId, text) VALUES (nextval( 'posts_SEQ' ), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a12', 'Post post and post');
...
INSERT INTO user_role (id, role, user_id, tenant_id) VALUES (nextval( 'user_role_SEQ' ), 'ADMIN', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a14', 'xds1'); -- starnowski as ADMIN
INSERT INTO user_role (id, role, user_id, tenant_id) VALUES (nextval( 'user_role_SEQ' ), 'AUTHOR', 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'xds1'); -- dude as AUTHOR

INSERT INTO posts (id, userId, text) VALUES (nextval( 'posts_SEQ' ), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'First post in application for xds1');
INSERT INTO posts (id, userId, text) VALUES (nextval( 'posts_SEQ' ), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a15', 'Second post in application for xds1');
